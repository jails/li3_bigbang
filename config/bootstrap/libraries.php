...
/**
 * This is the path to the root project used by your application.
 */
define('LITHIUM_ROOT_PATH', dirname(dirname(__DIR__)));
 ...
 */
define('LITHIUM_LIBRARY_PATH', LITHIUM_ROOT_PATH . '/libraries');
 ...
 */
define('LITHIUM_APP_PATH', LITHIUM_ROOT_PATH . '/atoms/app');
...
/**
* Adds the appropriate library paths for the atoms.
*/
Libraries::paths([
	'libraries' => [
		'{:app}/libraries/{:name}',
		'{:root}/../atoms/{:name}', //should be {:root}/atoms/{:name}
		'{:root}/{:name}'           //should be {:root}/libraries/{:name}
	]
]);
...
/**
 * Add the admin area application.
 */
Libraries::add('admin');

/**
 * Add the test area application.
 */
